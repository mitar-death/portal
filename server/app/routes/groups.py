...
from server.app.schemas.schemas import GroupsResponse, SelectedGroupsRequest
...
@groups_routes.post(
    "/add/selected-groups", tags=["Groups"], response_model=GroupsResponse
)
async def add_selected_groups(request: Request, selected_groups: SelectedGroupsRequest):
    """
