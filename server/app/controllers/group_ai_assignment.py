...
@safe_db_operation()
async def get_group_ai_assignments(request: Request, db: AsyncSession = None) -> Dict[str, Any]:
    """
...
@safe_db_operation()
async def update_group_ai_assignment(request: Request, db: AsyncSession = None) -> Dict[str, Any]:
    """
