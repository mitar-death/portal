...
async def start_monitoring(user_id=None):
    ...
    try:
        ...
        message_handler_task = asyncio.create_task(_setup_message_handler(client, active_user_id))
        ...
        while True:
            try:
                ...
                ai_status = {
                    ...
                    "ai_accounts": len(getattr(ai_messenger, 'ai_clients', {})) if ai_messenger else 0
                }
        ...
        if ai_messenger:
            try:
                ...
                if hasattr(ai_messenger, 'diagnostic_check'):
                    ...
                    ai_diagnostics = {
                        "ai_status": {
                            "is_initialized": bool(getattr(ai_messenger, 'ai_clients', {})),
                            "ai_clients_count": len(getattr(ai_messenger, 'ai_clients', {})),
                            "active_tasks_count": len(getattr(ai_messenger, 'active_tasks', set())),
                        }
                    }
            except Exception as e:
