...
def check_match_with_any_format(chat_id: Union[int, str], 
                               monitored_ids: Set[str]) -> Tuple[bool, Optional[str]]:
    """
...
def log_group_monitoring_status(monitored_ids: Set[str], title: str = "Current Monitored Groups"):
    """
    ...
    formatted_groups = [
        f"{gid} (display: {format_group_id_for_display(gid)})" 
