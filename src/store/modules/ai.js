...
export default {
    ...
    actions: {
        ...
        async fetchAIAccounts({ commit }) {
            ...
            console.log(
                "🚀 Attempting to fetch AI accounts (letting backend handle auth validation)",
            );
        ...
        async createAIAccount({ dispatch }, newAccount) {
            try {
                const response = await fetchWithAuth(`${apiUrl}/ai/accounts`, {
                    method: "POST",
                    headers: {
        ...
        async updateAIAccount(
            { dispatch },
            { accountId, isActive, name, shareable_link, ai_response_context },
        ) {
            try {
                const payload = {
                ...
                if (shareable_link !== undefined)
                    payload.shareable_link = shareable_link;
                if (ai_response_context !== undefined)
                    payload.ai_response_context = ai_response_context;
        ...
        async deleteAIAccount({ dispatch }, accountId) {
            try {
                const response = await fetchWithAuth(`${apiUrl}/ai/accounts/delete`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    },
        ...
        async testAIAccount({ dispatch }, accountId) {
            try {
                const response = await fetchWithAuth(`${apiUrl}/ai/accounts/test`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
        ...
        async loginAIAccount(
            { dispatch },
            { accountId, action, phoneCode, password },
        ) {
            try {
                const payload = {
                    account_id: accountId,
                ...
                const response = await fetchWithAuth(`${apiUrl}/ai/accounts/login`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
                ...
                console.error(
                    "Error in AI account login process:",
                    error.details,
                );
                dispatch(
                    "ui/showSnackbar",
        ...
        async logoutAIAccount({ dispatch }, accountId) {
            try {
                const response = await fetchWithAuth(`${apiUrl}/ai/accounts/logout`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
        ...
        async cleanupAISessions({ dispatch }) {
            try {
                const response = await fetchWithAuth(
                    `${apiUrl}/ai/accounts/cleanup-sessions`,
                    {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                ...
                if (result.success) {
                    ...
                    dispatch(
                        ...
                        {
                            text:
                                result.message || "Failed to cleanup sessions",
                            color: "error",
                        },
                        { root: true },
                    );
        ...
        async fetchGroupAssignments({ commit }) {
            // Let the backend handle authentication - it validates JWT tokens properly
            console.log(
                "🚀 Attempting to fetch group assignments (letting backend handle auth validation)",
            );

            try {
                const response = await fetchWithAuth(
                    `${apiUrl}/ai/group-assignments`,
                    {
                        method: "GET",
                    },
                );
            ...
            try {
                ...
                if (result.success) {
                    ...
                    const error = new Error(
                        result.error ||
                            result.message ||
                            "Unknown error updating assignment",
                    );
                    console.error(
                        "Error updating assignment (API reported failure):",
                        error,
                    );
